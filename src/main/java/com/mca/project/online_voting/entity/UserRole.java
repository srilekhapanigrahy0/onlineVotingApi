...
public class UserRole {
    ...
    @JoinColumn(name = "user_id", insertable = false, updatable = false) // user_id column is managed by EmbeddedId
    private Users user;
    ...
    @JoinColumn(name = "company_id", insertable = false, updatable = false) // company_id column is managed by EmbeddedId
    ...
    public UserRole(Long userId, Long companyId, String role) {
